package net.juhwan203.thisiskotlin.firebasestorage
...
import net.juhwan203.thisiskotlin.firebasestorage.databinding.ActivityMainBinding

class MainActivity : AppCompatActivity() {
    val storage = Firebase.storage("gs://this-is-android-with-kot-8880d.appspot.com")
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnDownload.setOnClickListener {
            downloadImage("images/temp_1667957909880.jpeg")
        }
    }
